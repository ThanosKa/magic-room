...
const CREDIT_PACKAGES = [
  {
    ...
    features: ["30 credits", "~30 design generations", "Full resolution images"],
    popular: false,
  },
  {
    id: "pro",
  ...
  },
  {
    ...
    features: ["300 credits", "~300 design generations", "24/7 priority support"],
    popular: false,
  },
];
...
export default function PurchasePage() {
  ...
  const handlePurchase = async (packageId: string) => {
    // If not signed in, show Clerk modal
    if (!clerkUser) {
      signIn?.redirectToSignUp({
        ...
        {clerkUser && (
          <div className="mt-6 inline-block rounded-full bg-purple-100 px-4 py-2 dark:bg-purple-900/30">
            <p className="text-sm font-medium">
              Current balance: <span className="text-purple-600 dark:text-purple-400">{credits} credits</span>
            </p>
          </div>
        )}
      </div>
      ...
      <div className="mt-16 max-w-2xl mx-auto">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-2 rounded-lg bg-slate-50 p-4 dark:bg-slate-900/50">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Credits never expire. Use them anytime you want to generate new designs.
            </p>
          </div>
          ...
          <div className="space-y-2 rounded-lg bg-slate-50 p-4 dark:bg-slate-900/50">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400">
              Yes, contact our support team within 7 days of purchase for a full refund.
            </p>
          </div>
